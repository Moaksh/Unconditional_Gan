...
from model_load.lightweight_gan.diff_augment import DiffAugment
...
from model_load.huggan_mixin import HugGANModelHubMixin
...
class FCANet(nn.Module):
    def __init__(
        ...
        chan_intermediate = m--ax(3, chan_out // reduction)
...
class Trainer():
    ...
    def get_remote_checkpoints(self):
        ...
        try:
            ...
            model_path = "./models/default/model.pt"
